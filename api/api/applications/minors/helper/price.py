...
def calcola_ricavi_tra_date(data_inizio, data_fine, minor_price):
    total_ricavi = 0
    ...
    for i in range(differenza.days + 1):
        ...
        total_ricavi += calcola_value_by_date(data_corrente, minor_price)

    return total_ricavi


def calcola_value_by_date(date, minor_price):
