...
class PDF(FPDF, HTMLMixin):
    ...
    def create_section_1(self):
        ...
        self.set_font(size=10)
        self.set_font("DejaVu", "B")
        self.cell(0, h=5, txt="", border=0, ln=1, align="", fill=False, link="")
        self.set_font("DejaVu")
        self.set_font(size=10.5)
    ...
    def create_section_2(self):
        ...
        self.set_y(49)
        self.set_x(169)
        self.cell(0, h=6, txt="Dell' adulto", border=0, ln=1, align="", fill=False, link="")
    ...
    def create_section_3(self):
        ...
        self.cell(
            0,
            h=6,
            txt="SCHEDA INFORMATIVA DELL'ADULTO",
            border=0,
            ln=1,
            align="",
            fill=False,
    ...
    def add_to_section_3(self, adult):
        self.set_y(56)
        self.set_x(48)
        self.cell(
            0,
            h=6,
            txt=adult["surname"] + " " + adult["name"],
            border=0,
            ln=1,
            align="",
            fill=False,
        ...
        self.set_x(33)
        # adult["birthdate"].strftime("%d/%m/%Y")
        self.cell(
            0,
            h=6,
            txt=adult["birthdate"],
        ...
        self.set_x(33)
        self.cell(0, h=5, txt=adult["resident"], border=0, ln=1, align="", fill=False, link="")
        self.set_x(33)
        self.cell(
            0,
            h=5,
        ...
        self.set_y(68)
        self.set_x(130)
        self.cell(0, h=5, txt=adult["county"], border=0, ln=1, align="", fill=False, link="")
        self.set_y(73)
        self.set_x(120)
        self.cell(
            0,
            h=5,
            txt=adult["paternity_residence"],
            border=0,
            ln=1,
            align="",
            fill=False,
        ...
        self.cell(
            0,
            h=5,
            txt=adult["legal_guardian_residence"],
            border=0,
            ln=1,
            align="",
            fill=False,
        ...
        self.cell(
            0,
            h=5,
            txt=adult["social_worker_municipality"],
            border=0,
            ln=1,
            align="",
            fill=False,
        ...
        self.cell(
            0,
            h=5,
            txt=adult["legal_guardian_phone_number"],
            border=0,
            ln=1,
            align="",
            fill=False,
        ...
        self.cell(
            0,
            h=5,
            txt=adult["social_worker_phone_number"],
            border=0,
            ln=1,
            align="",
            fill=False,
    ...
    def create_section_4(self):
        ...
        self.cell(
            0,
            h=5,
            txt="SOSPESA RESPONSABILITA' GENITORIALE ",
            border=0,
            ln=1,
            align="",
            fill=False,
        ...
        self.rect(68 + 15, 169, 3, 3, style="")  # si
        self.set_y(169)
        self.set_x(71 + 15)
        self.cell(0, h=5, txt="SI", border=0, ln=1, align="", fill=False, link="")
        self.rect(78 + 15, 169, 3, 3, style="")  # no
        self.set_y(169)
        self.set_x(81 + 15)
        self.cell(0, h=5, txt="NO", border=0, ln=1, align="", fill=False, link="")
        self.set_line_width(0.4)
        self.line(14, 177, 200, 177)

    def add_to_section_4(self, adult):
        self.set_y(113)
        self.set_x(45)
        self.cell(
            0,
            h=5,
            txt=adult["disposal_date"],
            border=0,
            ln=1,
            align="",
            fill=False,
        ...
        if adult["origin"]["type"] == "other_struct":
            self.line(13, 152, 16, 155)
            self.line(13, 155, 16, 152)
            if adult["origin"]["detailed"] != "":
                txt, rest_of_string = split_sentence(15, adult["origin"]["detailed"])
        ...
        if "mun" in adult["placed_by"]["typology"]:
            self.line(89, 142, 92, 145)
            self.line(89, 145, 92, 142)
            if adult["placed_by"]["mun_of"] != "":
                self.set_y(141)
                self.set_x(112)
                self.cell(
                    0,
                    h=5,
                    txt=adult["placed_by"]["mun_of"],
                    border=0,
                    ln=1,
                    align="",
                    fill=False,
        ...
        if "police" in adult["placed_by"]["typology"]:
            ...
            elif adult["placed_by"]["type"] == "cc":
                self.line(89, 147, 92, 150)
                self.line(89, 150, 92, 147)
        if "police" in adult["placed_by"]["typology"]:
            if adult["placed_by"]["tri_min_of"] != "":
                self.set_y(152)
                self.set_x(116)
                self.cell(
                    0,
                    h=5,
                    txt=adult["placed_by"]["tri_min_of"],
                    border=0,
                    ln=1,
                    align="",
                    fill=False,
            ...
            if adult["placed_by"]["giudge"] != "":
                self.set_y(158)
                self.set_x(115)
                self.cell(
                    0,
                    h=5,
                    txt=adult["placed_by"]["giudge"],
                    border=0,
                    ln=1,
                    align="",
                    fill=False,
            ...
            if adult["placed_by"]["fasc_n"] != "":
                self.set_y(159)
                self.set_x(170)
                self.cell(
                    0,
                    h=5,
                    txt=adult["placed_by"]["fasc_n"],
                    border=0,
                    ln=1,
                    align="",
                    fill=False,
        ...
        if adult["susp_parent_res"]:
            self.line(68 + 15, 169, 68 + 15 + 3, 172)
            self.line(68 + 15, 172, 68 + 15 + 3, 169)
        else:
            self.line(78 + 15, 169, 78 + 15 + 3, 172)
            self.line(78 + 15, 172, 78 + 15 + 3, 169)
    ...
    def add_to_section_5(self, semestral_comunication):
        if semestral_comunication["family_members_meeting"]["member"] == "padre":
            self.line(60, 176, 63, 179)
            self.line(60, 179, 63, 176)
        elif semestral_comunication["family_members_meeting"]["member"] == "madre":
            self.line(78, 176, 81, 179)
            self.line(78, 179, 81, 176)
        elif semestral_comunication["family_members_meeting"]["member"] == "fratelli":
            self.line(96, 176, 99, 179)
            self.line(96, 179, 99, 176)
        elif semestral_comunication["family_members_meeting"]["member"] == "nonni":
            self.line(113, 176, 116, 179)
            self.line(113, 179, 116, 176)
        elif semestral_comunication["family_members_meeting"]["member"] == "zii":
        ...
        if semestral_comunication["evolutionary_path"] != "":
            ...
            self.cell(
                0,
                h=5,
                txt=semestral_comunication["evolutionary_path"][0:77],
                border=0,
                ln=0,
                align="",
                fill=False,
            ...
            if len(semestral_comunication["evolutionary_path"]) > 77:
                self.set_y(234)
                self.set_x(13)
                self.cell(
                    0,
                    h=5,
                    txt=semestral_comunication["evolutionary_path"][77:],
                    border=0,
                    ln=0,
                    align="",
                    fill=False,
    ...
    def create_footer(self):
        ...
        self.line(58, 260 - 60, 119, 260 - 60)
        self.rect(122, 246 - 60, 3, 3, style="")
        self.set_y(245 - 60)
        self.set_x(125)
        self.cell(
            0,
        ...
        self.rect(122, 252 - 60, 3, 3, style="")
        self.set_y(251 - 60)
        self.set_x(125)
        self.cell(
            0,
        ...
        self.rect(122, 257 - 60, 3, 3, style="")
        self.set_y(256 - 60)
        self.set_x(125)
        self.cell(
            0,
        ...
        self.rect(155, 246 - 60, 3, 3, style="")
        self.set_y(245 - 60)
        self.set_x(158)
        self.cell(
            0,
        ...
        self.rect(155, 252 - 60, 3, 3, style="")
        self.set_y(251 - 60)
        self.set_x(158)
        self.cell(
            0,
        ...
        self.rect(155, 257 - 60, 3, 3, style="")
        self.set_font("DejaVu", "B")
        self.set_y(256 - 60)
        self.set_x(158)
        self.cell(
        ...
        self.set_line_width(0.4)
        self.line(168, 260 - 60, 196, 260 - 60)
        self.line(14, 268 - 60, 101, 268 - 60)
        self.set_font("DejaVu", size=8)
        self.set_y(262 - 60)
        self.set_x(103)
        self.cell(
    ...
    def add_to_footer(self, semestral_comunication):
        if "family_returns" in semestral_comunication["adult_expectation"]["type"]:
            self.line(15, 246 - 60, 18, 249 - 60)
            self.line(15, 249 - 60, 18, 246 - 60)
        if "family_foster_care" in semestral_comunication["adult_expectation"]["type"]:
            self.line(15, 252 - 60, 18, 255 - 60)
            self.line(15, 255 - 60, 18, 252 - 60)
        if "adoption" in semestral_comunication["adult_expectation"]["type"]:
            self.line(15, 257 - 60, 18, 260 - 60)
            self.line(15, 260 - 60, 18, 257 - 60)
        if "autonomy_routes" in semestral_comunication["adult_expectation"]["type"]:
            self.line(47, 246 - 60, 50, 249 - 60)
            self.line(47, 249 - 60, 50, 246 - 60)
        if "not_evaluable" in semestral_comunication["adult_expectation"]["type"]:
            self.line(47, 252 - 60, 50, 255 - 60)
            self.line(47, 255 - 60, 50, 252 - 60)
        if "other" in semestral_comunication["adult_expectation"]["type"]:
            self.line(47, 257 - 60, 50, 260 - 60)
            self.line(47, 260 - 60, 50, 257 - 60)
            if semestral_comunication["adult_expectation"]["other"] != "":
                ...
                self.cell(
                    0,
                    h=5,
                    txt=semestral_comunication["adult_expectation"]["other"],
                    border=0,
                    ln=1,
                    align="",
                    fill=False,
        ...
        if "family_returns" in semestral_comunication["target"]["type"]:
            self.line(122, 246 - 60, 125, 249 - 60)
            self.line(122, 249 - 60, 125, 246 - 60)
        if "family_foster_care" in semestral_comunication["target"]["type"]:
            self.line(122, 252 - 60, 125, 255 - 60)
            self.line(122, 255 - 60, 125, 252 - 60)
        if "adoption" in semestral_comunication["target"]["type"]:
            self.line(122, 257 - 60, 125, 260 - 60)
            self.line(122, 260 - 60, 125, 257 - 60)
        if "autonomy_routes" in semestral_comunication["target"]["type"]:
            self.line(155, 246 - 60, 158, 249 - 60)
            self.line(155, 249 - 60, 158, 246 - 60)
        if "not_evaluable" in semestral_comunication["target"]["type"]:
            self.line(155, 252 - 60, 158, 255 - 60)
            self.line(155, 255 - 60, 158, 252 - 60)
        if "other" in semestral_comunication["target"]["type"]:
            self.line(155, 257 - 60, 158, 260 - 60)
            self.line(155, 260 - 60, 158, 257 - 60)
    ...
    def add_data_to_document(self, info):
        ...
        self.add_to_section_3(info["adult"])
        self.add_to_section_4(info["adult"])
...
def generate_adult_information_sheet(info=None):
    pdf = PDF()
    pdf.add_page()
    fonts = [
...
def archive_adult_information_sheet(db=None, info_adult=None, info=None):
    pdf = PDF()
    pdf.add_page()
    fonts = [
        ("DejaVu", "", FONT_DEJAVU_SANS_CONDENSED),
    ...
    date = datetime.strptime(info_adult.get("info_sheet").get("semestral_comunication").get("date"), "%d/%m/%Y")
    document = {
        "id_adult": info_adult.get("_id"),
        "name": info_adult.get("name"),
        "surname": info_adult.get("surname"),
        "fiscal_code": info_adult.get("fiscal_code"),
        "archive_date": date,
        "pdf_data": pdf_content_base64,
    }
    result = db["adult_info_sheets"].insert_one(document)
    return result
